...
* `transaction` - *required* `Object` type of [StellarTransaction](https://github.com/OneKeyHQ/connect/blob/onekey/src/js/types/stellar.js#L129)

### Stellar SDK compatibility

`stellar-sdk` is not a part of `@onekeyhq/connect` repository. To transform `StellarSDK.Transaction` object into `OneKeyConnect.StellarTransaction` object copy [this plugin](https://github.com/OneKeyHQ/connect/blob/onekey/src/js/plugins/stellar/plugin.js) into your project.
