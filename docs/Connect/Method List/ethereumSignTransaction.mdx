...
* `transaction` - *required* `Object` type of [EthereumTransaction](https://github.com/OneKeyHQ/connect/blob/onekey/src/js/types/ethereum.js#L5) "0x" prefix for each field is optional
